...
;
    ...
    <?php
          ...
          echo  '<font size="2px"><a href="docs/media/'.$donnees['filename'].'"> '.$donnees['filename'].'</font> </a>';
          echo ' <font size="2px">  '.$donnees['file_date'].'</font><br/>';
          echo '</span>';
    ?>
...
$sql = "SELECT * from pdf_data  WHERE file_date LIKE 2025 order by id desc";
$query = $dbh -> prepare($sql);
$query->execute();
