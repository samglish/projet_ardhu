      ...
      <header>
       ...
       <main class="main">
        <section class="page-content">
            <center>
        <h1>FINANCE 2019</h1> </br></br></center>
...
<?php
    ...
    if (!empty($requete))
    {
        $req = "SELECT * FROM pdf_data WHERE file_des LIKE '%$requete%' and file_date LIKE 2019 and file_rep LIKE 'F'"; 
        $exec = $conn->query($req);                            
// exécuter la requête
...
<center>
       ...
       ';
$sql = "SELECT * from pdf_data  WHERE file_date LIKE 2019 and file_rep LIKE 'F' order by id desc";
$query = $dbh -> prepare($sql);
$query->execute();
