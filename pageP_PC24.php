      ...
      <header>
       ...
       <main class="main">
        <section class="page-content">
            <center>
        <h1>PARC CAMEROUN 2024</h1> </br></br></center>
...
<?php
    ...
    if (!empty($requete))
    {
        $req = "SELECT * FROM pdf_data WHERE file_des LIKE '%$requete%' and file_date LIKE 2024 and file_rep LIKE 'PC24'"; 
        $exec = $conn->query($req);                            
// exécuter la requête
...
echo '</article>
     ...
     <center>
            ...
            ';
$sql = "SELECT * from pdf_data  WHERE file_date LIKE 2024 and file_rep LIKE 'PC24' order by id desc";
$query = $dbh -> prepare($sql);
$query->execute();
