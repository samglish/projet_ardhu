      ...
      <header>
       ...
       <main class="main">
        <section class="page-content">
            <center>
        <h1>PROTECTION GENERALE 2021</h1> </br></br></center>
...
<?php
    ...
    if (!empty($requete))
    {
        $req = "SELECT * FROM pdf_data WHERE file_des LIKE '%$requete%' and file_date LIKE 2021 and file_rep LIKE 'PG'"; 
        $exec = $conn->query($req);                            
// exécuter la requête
...
<center>
       ...
       ';
$sql = "SELECT * from pdf_data  WHERE file_date LIKE 2021 and file_rep LIKE 'PG' order by id desc";
$query = $dbh -> prepare($sql);
$query->execute();
...
<?php
    ...
    $db_server = 'localhost'; // Adresse du serveur MySQL
    $db_name = 'ardhuc8991_dbArdhu';            // Nom de la base de données
    $db_user_login = 'ardhuc8991_ardhu';  // Nom de l'utilisateur
    $db_user_pass = 'CloudArdhu2025';       // Mot de passe de l'utilisateur
